...
def store_as_hdf5(gen_params, met_model, names_km, ss_idx, output_path, output_name):
    ...
    path_to_tmodel = f'models/{met_model}/thermo/constraint_based_model_scaffold.json'
    path_to_kmodel = f'models/{met_model}/kinetic/kinetic_model_scaffold.yaml'
    ...
    #kmodel.prepare()
    kmodel = kinetic_model_prepare_ignore_int_issues(kmodel)
